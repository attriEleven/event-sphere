        ...
        <div className="mt-4 mb-6 flex flex-wrap items-center justify-between gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="px-3 py-2 text-sm border border-gray-300 rounded-md bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            >
